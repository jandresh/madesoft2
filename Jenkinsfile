        ...
        stage('Deploy Developer') {
            ...
            steps {
                container('kubectl') {
                    ...
                    step([$class: 'KubernetesEngineBuilder', namespace: "${env.BRANCH_NAME}", projectId: env.PROJECT, clusterName: env.CLUSTER, zone: env.CLUSTER_ZONE, manifestPattern: 'corews/kube/dev', credentialsId: env.JENKINS_CRED, verifyDeployments: false])
        ...
        stage('Deploy Canary') {
            ...
            steps {
                container('kubectl') {
                    ...
                    step([$class: 'KubernetesEngineBuilder', namespace: "production", projectId: env.PROJECT, clusterName: env.CLUSTER, zone: env.CLUSTER_ZONE, manifestPattern: 'corews/kube/canary', credentialsId: env.JENKINS_CRED, verifyDeployments: false])
        ...
        stage('Deploy Production') {
            ...
            steps{
                container('kubectl') {
                    ...
                    step([$class: 'KubernetesEngineBuilder', namespace: "production", projectId: env.PROJECT, clusterName: env.CLUSTER, zone: env.CLUSTER_ZONE, manifestPattern: 'corews/kube/services', credentialsId: env.JENKINS_CRED, verifyDeployments: false])
                    step([$class: 'KubernetesEngineBuilder', namespace: "production", projectId: env.PROJECT, clusterName: env.CLUSTER, zone: env.CLUSTER_ZONE, manifestPattern: 'corews/kube/production', credentialsId: env.JENKINS_CRED, verifyDeployments: false])
                    step([$class: 'KubernetesEngineBuilder', namespace: "production", projectId: env.PROJECT, clusterName: env.CLUSTER, zone: env.CLUSTER_ZONE, manifestPattern: 'preprocessingws/kube/services', credentialsId: env.JENKINS_CRED, verifyDeployments: false])
